...
class PredictionService:
    ...
    def predict(self, archive_folder_name) -> dict:
        predictions = {
            "frames" : [],
            "times" : [],
            "strum" : []
        ...
        audio_path = "data/audio/temp/" + archive_folder_name + "/audio.wav"
    ...
    def __predict_full_audio(self, path_to_audio) -> np.ndarray:
        ...
        #return [get_predicted_strum_of_sample(x) for x in np.swapaxes(y, 0, 1)]